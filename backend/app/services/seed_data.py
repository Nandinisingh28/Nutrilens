...
INGREDIENT_RISKS = [
    ...
    ("ins 950",          "artificial_sweetener", RiskLevel.MEDIUM, "Artificial sweetener (Acesulfame K)"),
    ("ins 951",          "artificial_sweetener", RiskLevel.MEDIUM, "Artificial sweetener (Aspartame)"),
    ("ins 955",          "artificial_sweetener", RiskLevel.LOW,    "Artificial sweetener (Sucralose)"),
    ...
    ("liquid glucose",   "added_sugar",          RiskLevel.HIGH,   "Highly refined liquid sugar"),
    ("invert sugar",     "added_sugar",          RiskLevel.MEDIUM, "Processed sugar syrup"),
    ("maida",            "refined_flour",        RiskLevel.MEDIUM, "Refined wheat flour, stripped of nutrients"),
    ("refined wheat flour", "refined_flour",     RiskLevel.MEDIUM, "Refined wheat flour, spikes blood sugar"),
    # Preservatives
    ("sodium benzoate",  "preservative",         RiskLevel.MEDIUM, "Common preservative (INS 211)"),
    ("potassium sorbate","preservative",         RiskLevel.LOW,    "Common preservative (INS 202)"),
    ...
    ("tbhq",             "preservative",         RiskLevel.HIGH,   "Tertiary butylhydroquinone (INS 319)"),
    ("ins 211",          "preservative",         RiskLevel.MEDIUM, "Common chemical preservative (Sodium Benzoate)"),
    ("ins 202",          "preservative",         RiskLevel.LOW,    "Chemical preservative (Potassium Sorbate)"),
    ("ins 223",          "preservative",         RiskLevel.MEDIUM, "Sulphite preservative, allergen risk"),
    # Artificial colors
    ...
    ("tartrazine",       "artificial_color",     RiskLevel.MEDIUM, "Artificial color (E102/INS 102)"),
    ...
    ("ins 102",          "artificial_color",     RiskLevel.MEDIUM, "Artificial color (Tartrazine)"),
    ("ins 110",          "artificial_color",     RiskLevel.MEDIUM, "Artificial dye (Sunset Yellow)"),
    ("caramel color",    "artificial_color",     RiskLevel.MEDIUM, "Processed colorant, potential carcinogen at high levels"),
    ("ins 150",          "artificial_color",     RiskLevel.MEDIUM, "Processed Caramel Coloring"),
    # Poor Quality Fats
    ("partially hydrogenated", "trans_fat",      RiskLevel.HIGH,   "Contains trans fats"),
    ("palm oil",         "poor_fat",             RiskLevel.MEDIUM, "High in saturated fat. Suggestion: Choose Sunflower, Olive, or Mustard oil."),
    ("palmolein",        "poor_fat",             RiskLevel.MEDIUM, "Highly processed fat. Suggestion: Choose Sunflower, Olive, or Mustard oil."),
    ("dalda",            "trans_fat",            RiskLevel.HIGH,   "Hydrogenated vegetable oil, severe trans fat risk"),
    ("vanaspati",        "trans_fat",            RiskLevel.HIGH,   "Hydrogenated vegetable oil, severe trans fat risk"),
    ("hydrogenated vegetable oil", "trans_fat",  RiskLevel.HIGH,   "Primary source of artificial trans fats"),
    ("interesterified fat", "processed_fat",     RiskLevel.MEDIUM, "Chemically altered fat structure"),
    # Flavor enhancers
    ...
    ("ajinomoto",        "flavor_enhancer",      RiskLevel.LOW,    "Flavor enhancer (MSG)"),
    ("ins 621",          "flavor_enhancer",      RiskLevel.LOW,    "Monosodium Glutamate (MSG) Flavor Enhancer"),
    ("ins 627",          "flavor_enhancer",      RiskLevel.LOW,    "Disodium Guanylate (Umami Enhancer)"),
    ("ins 631",          "flavor_enhancer",      RiskLevel.LOW,    "Disodium Inosinate (Often from animal origin)"),
    ...
    ("ins 407",          "thickener",            RiskLevel.MEDIUM, "Carrageenan Thickener (Gut Health Concerns)"),
    ("ins 433",          "emulsifier",           RiskLevel.MEDIUM, "Polysorbate 80 (Gut Health Concerns)"),
]
